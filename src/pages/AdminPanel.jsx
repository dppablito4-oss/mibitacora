        ...
        <div className="mx-auto max-w-6xl flex items-center justify-between px-6 py-3">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] bg-accent-600/15 text-accent-400 px-2 py-0.5 rounded-full font-semibold">Panel</span>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="flex gap-1 overflow-x-auto no-scrollbar py-2">
            {TABS.map(tab => (
              <button
                key={tab.id}
                onClick={() => { setActiveTab(tab.id); if (tab.id === 'bitacora') setShowEditor(false); }}
              ...
              <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-8">
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <input value={titulo} onChange={e => setTitulo(e.target.value)} placeholder="Título de la entrada..." className={inputClass} />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input value={tags} onChange={e => setTags(e.target.value)} placeholder="react, supabase, ia" className={inputClass} />
                    </div>
                  </div>

                  <div>
                    <label className="block text-xs font-medium text-zinc-400 mb-2">Contenido (Markdown)</label>
                    <textarea value={contenido} onChange={e => setContenido(e.target.value)} placeholder="Escribe el contenido de la entrada..." rows={12} className={`${inputClass} resize-none font-mono`} />
                  </div>
