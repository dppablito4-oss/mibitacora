...
export default function HomePage() {
  ...
  return (
    <div className="pt-20">
      ...
      {/* Módulos de Herramientas Section */}
      <section id="modulos" className="relative py-20 border-t border-tesseract-500/10 bg-card/40">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <Link to="/scanner" className="reveal group block border border-slate-800 bg-dark p-6 transition-all hover:border-tesseract-500 hover:shadow-[0_0_20px_rgba(6,182,212,0.15)] rounded-xl relative overflow-hidden">
            ...
            <Link to="/qr" className="reveal reveal-delay-1 group block border border-slate-800 bg-dark p-6 transition-all hover:border-tesseract-500 hover:shadow-[0_0_20px_rgba(6,182,212,0.15)] rounded-xl relative overflow-hidden">
              <div className="absolute inset-0 bg-tesseract-500/5 opacity-0 group-hover:opacity-100 transition-opacity" />
            ...
            <Link to="/math" className="reveal reveal-delay-2 group block border border-slate-800 bg-dark p-6 transition-all hover:border-tesseract-500 hover:shadow-[0_0_20px_rgba(6,182,212,0.15)] rounded-xl relative overflow-hidden">
              <div className="absolute inset-0 bg-tesseract-500/5 opacity-0 group-hover:opacity-100 transition-opacity" />
            ...
            <Link to="/tripticos" className="reveal reveal-delay-3 group block border border-slate-800 bg-dark p-6 transition-all hover:border-tesseract-500 hover:shadow-[0_0_20px_rgba(6,182,212,0.15)] rounded-xl relative overflow-hidden">
              <div className="absolute inset-0 bg-tesseract-500/5 opacity-0 group-hover:opacity-100 transition-opacity" />
